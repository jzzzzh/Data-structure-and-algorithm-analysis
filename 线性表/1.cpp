...
public:
    jumpList();
    jumpList(list *fir, list *sec, list *thir);
    void printFir();
    void printSec();
    void printThi();
...
jumpList::jumpList() : firstList(nullptr), secoList(nullptr), thirList(nullptr) {}
jumpList::jumpList(list *fir, list *sec, list *thir) : firstList(fir), secoList(sec), thirList(thir) {}
